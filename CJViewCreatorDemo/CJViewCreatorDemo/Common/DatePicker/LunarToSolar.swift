...
class LunarToSolar {
    ...
    /// 判断指定年份是否有闰月
    static func lunarLeapMonth(of year: Int) -> Int {
        for i in 1...12 {
            let monthInfo = LunarToSolar.convert(year: year, month: i, day: 1)
            if monthInfo.0 == true {
                return i
            }
        }
    ...
    static func convert(year: Int, month: Int, day: Int) -> (Bool, Int){
        ...
        let leapDic = [1952:5, 1955:3, 1957:8, 1960:6, 1963:4, 1966:3, 1968:7,
                       ...
                       2047:5, 2050:3, 2052:8, 2055:6, 2058:4, 2061:3, 2063:7,
                       2066:5, 2069:4, 2071:8, 2074:6, 2077:4, 2080:3, 2082:7,
                       2085:5, 2088:4, 2090:8, 2093:6, 2096:4, 2099:2]
        ...
        let monthDays = GetBitInt(data: days, length: 1, shift: 12-loopend) == 1 ? 30 : 29
        offset += day
