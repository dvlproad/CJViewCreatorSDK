...
// MARK: - 数据模型
//struct CJTextComponentConfigModel: Identifiable {
//    let id = UUID()
//    let title: String
...
struct CJTextListRow: View {
    ...
    let valueChangeBlock: (_ newItems: [CJTextComponentConfigModel], _ newSelectedIndex: Int, _ oldCount: Int, _ newCount: Int) -> Void // 添加、删除、切换选中
    
//    init(minCount: Int = 0, maxCount: Int = 10, items: Binding<[CJTextComponentConfigModel]>, currentIndex: Int = 0, valueChangeBlock: @escaping (_ newItems: [CJTextComponentConfigModel], _ newSelectedIndex: Int, _ oldCount: Int, _ newCount: Int) -> Void
//    ) {
...
//            .background(Color.orange)
            ...
            HStack(spacing: 6) {
                ...
                AddButton {
                    ...
                    let initLayout =  CJTextLayoutModel(left: 30, top: 30, width: 100, height: 40, lineLimit: 1, fontSize: 15, fontWeight: .bold, font: font, foregroundColor: "#FFFF00", backgroundColor: "#FF00FF", textAlignment: .center, multilineTextAlignment: .center, minimumScaleFactor: 1, borderCornerRadius: 10, background: background)
                    let newItem = CJTextComponentConfigModel(id: "\(items.count)", data: initData, layout: initLayout)
                    // 添加在头部
...
//struct CJTextListRow_Previews: PreviewProvider {
//    static var previews: some View {
//        
//        let dataAndLayoutModels: [CJTextComponentConfigModel] = createDataAndLayoutModels()
//        let items = dataAndLayoutModels.map { $0.data }
//        
//        CJTextListRow(minCount: 1, maxCount: 3, items: .constant(dataAndLayoutModels), currentIndex: 3, valueChangeBlock: { newItems, newSelectedIndex, oldCount, newCount in
//            
//        })
//        .previewLayout(.sizeThatFits)
//        .padding() // 给预览添加一些边距
...
//    private static func createDataAndLayoutModels() -> [CJTextComponentConfigModel] {
//        let dataAndLayoutModels: [CJTextComponentConfigModel] = CJAllComponentConfigModel.getDefaultDataByLayoutId("").commemorationComponents
