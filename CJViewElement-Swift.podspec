  ...
  #验证方法2：pod lib lint CJViewElement-Swift.podspec --sources=cocoapods --allow-warnings --use-libraries --verbose
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dvlproad/CJViewCreatorSDK.git", :tag => "CJViewElement-Swift_0.0.3" }
